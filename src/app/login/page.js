...
function LoginForm() {
  ...
  // Touched state to trigger error messages only after user starts typing or blurs
  ...
  const errors = {
    name: touched.name && !isNameValid ? "Name is required" : "",
  ...
  const handleTabChange = (newMode) => {
    // Update query param without reloading, which triggers a re-render with new derived mode
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-slate-100 flex flex-col justify-center items-center px-4 relative overflow-hidden font-sans">
      ...
      <div className="absolute top-[10%] left-[10%] w-[350px] h-[350px] rounded-full bg-indigo-500/10 blur-[100px] pointer-events-none" />
      ...
      {/* Auth Card Container */}
      <div className="w-full max-w-[460px] glass-panel rounded-2xl p-8 relative z-10 transition-all duration-300 hover:border-white/12">
        
        {isSuccess ? (
          /* Mock Authentication Success State */
          <div className="text-center py-8 space-y-6 animate-fade-in">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2 justify-center pt-4">
                ...
                <Link href="/instructor/dashboard" className="text-xs bg-slate-800 hover:bg-slate-700 text-slate-300 px-3 py-1.5 rounded-lg border border-white/5 transition-all">
                  Instructor Studio
                </Link>
              </div>
            </div>
          ...
          <>
            ...
            <div className="flex bg-slate-900/60 p-1.5 rounded-xl border border-white/5 relative mb-6">
              <button
                ...
                className={`flex-1 text-center py-2 text-xs font-bold rounded-lg transition-all duration-300 z-10 ${
              ...
              <div
                className={`absolute top-1.5 bottom-1.5 left-1.5 w-[calc(50%-6px)] bg-indigo-600 rounded-lg shadow-md transition-all duration-300 ease-out pointer-events-none ${
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              {/* Register-only: Role Selector Tab Segment */}
              {mode === "signup" && (
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full py-3 mt-4 text-xs font-extrabold uppercase tracking-widest rounded-xl transition-all duration-300 shadow-md ${
            ...
            <div className="relative my-6 text-center">
              ...
              <span className="relative bg-[#172033] px-3.5 text-[10px] uppercase font-bold tracking-wider text-slate-500">
                Or Continue With
              </span>
            </div>
