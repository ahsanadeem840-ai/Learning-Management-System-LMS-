...
function SignupForm() {
  ...
  const handleChange = (e) => {
    ...
    setAuthError(""); // Clear errors on type
  };
      ...
      <div className="w-full max-w-[480px] glass-panel rounded-2xl p-8 relative z-10 transition-all duration-300 hover:border-white/12 shadow-indigo-500/5">
        ...
        {isSuccess ? (
          ...
          <>
            ...
            {authError && (
              <div className="mb-5 p-3.5 rounded-xl border border-red-500/20 bg-red-950/40 text-red-200 text-xs flex items-center gap-2.5 shadow-lg shadow-red-500/5 animate-fade-in font-sans">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 py-2.5 rounded-xl border border-white/5 bg-slate-950/20 text-xs font-semibold text-slate-300 hover:bg-white/5 hover:border-white/10 transition-all duration-200 cursor-pointer"
              >
