...
export default function StudentDashboard() {
  ...
  // Mock initial in-progress courses
  ...
  // Mock initial recommended courses
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {inProgressCourses.map((course) => (
            <div
              key={course.id}
              className="glass-panel rounded-2xl p-5 hover:border-white/15 transition-all duration-300 flex flex-col justify-between relative group"
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                ...
                <div className="pt-2">
                  {course.enrolled ? (
                    <button
                      disabled
                      className="w-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-bold py-2.5 px-4 rounded-xl flex items-center justify-center gap-1.5 cursor-not-allowed"
                    >
